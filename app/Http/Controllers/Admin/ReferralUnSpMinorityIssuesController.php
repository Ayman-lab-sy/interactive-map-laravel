...
class ReferralUnSpMinorityIssuesController extends Controller
{
    public function show(int $referralId)
    {
        ...
        return view(
            'admin.referrals.show_un_special_minority_issues',
    ...
    public function saveSummary(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'un_sp_minority_summary_saved'
        );

        return redirect()->route(
            'admin.referrals.un_sp.minority_issues.show',
            $referralId
    ...
    public function saveIdentity(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'un_sp_minority_identity_saved'
        );

        return redirect()->route(
            'admin.referrals.un_sp.minority_issues.show',
            $referralId
        )->with('success', 'تم حفظ هوية الأقلية.')
    ...
    public function saveViolation(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'un_sp_minority_violation_saved'
        );
    ...
    public function savePerpetrators(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'un_sp_minority_perpetrators_saved'
        );
    ...
    public function skipContext(int $referralId)
    {
        ...
        DB::connection('cases')->table('case_referral_audits')->insert([
            'referral_id' => $referralId,
            'action' => 'un_sp_minority_context_skipped',
            'user_id' => auth()->id(),
            'created_at' => now(),
        ]);
