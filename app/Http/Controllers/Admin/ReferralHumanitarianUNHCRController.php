...
class ReferralHumanitarianUNHCRController extends Controller
{
    public function show(int $referralId)
    {
        ...
        return view(
            'admin.referrals.show_humanitarian_unhcr',
    ...
    public function saveSource(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'humanitarian_unhcr_source_saved'
        );
    ...
    public function saveLocationTime(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'humanitarian_unhcr_location_time_saved'
        );
    ...
    public function saveNeeds(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'humanitarian_unhcr_needs_saved'
        );
    ...
    public function saveRisks(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'humanitarian_unhcr_risks_saved'
        );
    ...
    public function saveMandate(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'humanitarian_unhcr_mandate_saved'
        );

        return back()->with('success', 'تم حفظ فقرة اختصاص UNHCR.')->withFragment('block-e');
    }
    ...
    public function saveSnapshot(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'humanitarian_unhcr_snapshot_saved'
        );
    ...
    public function saveAssistance(Request $request, int $referralId)
    {
        ...
        $this->saveField(
            ...
            'humanitarian_unhcr_assistance_saved'
        );
