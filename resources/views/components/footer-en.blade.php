<footer class="footer">
  <p>All rights reserved © 2026 - The Alawites & Syrian Minorities Organization</p>
  ...
  <p>
    <a href="{{ route('privacy.new', app()->getLocale()) }}">Privacy Policy</a>
  </p>

  <p>
    <a href="{{ url(app()->getLocale() . '/contact') }}">Contact Us</a>
  </p>

  <div class="social-links" style="margin-top: 15px;">
    <a href="https://facebook.com" target="_blank">
      <img src="{{ asset('assets/icons/facebook.svg') }}" alt="Facebook" width="24">
    </a>
    <a href="https://twitter.com" target="_blank">
      <img src="{{ asset('assets/icons/twitter.svg') }}" alt="Twitter" width="24">
    </a>
    <a href="https://instagram.com" target="_blank">
      <img src="{{ asset('assets/icons/instagram.svg') }}" alt="Instagram" width="24">
    </a>
    <a href="https://t.me" target="_blank">
      <img src="{{ asset('assets/icons/telegram.svg') }}" alt="Telegram" width="24">
    </a>
    <a href="https://www.tiktok.com/@yourusername" target="_blank">
      <img src="{{ asset('assets/icons/tiktok.svg') }}" alt="TikTok" width="24">
    </a>
  </div>
</footer>
...
<div id="assistantHint"
  ...
  I’m the smart assistant.<br>
  Ask me about donations, joining, or support.
</div>
