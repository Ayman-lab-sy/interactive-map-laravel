...
<div class="section">
    ...
    <p>
        ...
        Alleged acts of violence against a woman or girl
    </p>
...
<div class="section">
    <p>
        ...
        its causes and consequences, in accordance with the mandate to examine
        and address situations involving alleged acts of gender-based violence
    ...
    <p>
        ...
        of the United Nations Special Rapporteur on violence against women and girls.
        The information contained herein is submitted strictly as reported,
        without legal qualification, determination, or attribution of responsibility.
    </p>
</div>
...
<div class="section">
    ...
    <p>
        The following information concerns allegations of acts of violence
        reportedly committed against a woman or girl, which may raise concerns
        under the mandate of the Special Rapporteur on violence against women and girls,
        its causes and consequences. The facts summarized below are presented
    ...
    <p class="note">
        ...
        not imply verification or legal assessment by the submitting organization.
    </p>
</div>

{{-- ================= II. Information on the Woman / Girl Concerned ================= --}}
<div class="section">
    <div class="section-title">II. Information on the Woman / Girl Concerned</div>

    <p>
        The woman or girl concerned is described below, based on the
        information provided by the source. Certain identifying details may
        be included where relevant, while others have been withheld or
        generalized for protection purposes.
    </p>
...
{{-- ================= III. Nature and Forms of Violence ================= --}}
<div class="section">
    <div class="section-title">III. Nature and Forms of Violence</div>

    <p>
        This section describes the nature and forms of violence reportedly
        experienced by the woman or girl concerned, as described by the source.
        This may include physical, psychological, sexual, economic, or other
        forms of abuse, whether occurring in the public or private sphere.
    </p>

    <p>
        {{ $violence_description_en }}
    </p>
</div>
...
<div class="section">
    ...
    <p>
        The following information summarizes details regarding the individual(s),
        group(s), or authority(ies) reportedly involved in the alleged acts,
        as described by the source. This information is presented without
...
<div class="section">
    ...
    <p>
        ...
        in relation to the alleged acts, or the reasons why such remedies
        were unavailable, ineffective, or would have posed a risk, is
